...
func _ready():
	...
	if minigame1_collision:
		...
		print("Minigame1 Collision enabled:", !minigame1_collision.is_disabled())
	else:
	...
	if minigame2_collision:
		...
		print("Minigame2 Collision enabled:", !minigame2_collision.is_disabled())
	else:
	...
	if minigame3_collision:
		...
		print("Minigame3 Collision enabled:", !minigame3_collision.is_disabled())
	else:
